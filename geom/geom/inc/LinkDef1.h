...
#pragma read sourceClass = "TGeoElement" targetClass = "TGeoElement" version = "[1-2]" source = "" target = "" code = \
...
#pragma read sourceClass = "TGeoTubeSeg" targetClass = "TGeoTubeSeg" version = "[1]" source = "" target = "" code = \
...
#pragma read sourceClass = "TGeoConeSeg" targetClass = "TGeoConeSeg" version = "[1]" source = "" target = "" code = \
   "{ newObj->AfterStreamer() ; }"
...
#pragma link C++ class TGDMLMatrix + ;
  ...
  #pragma link C++ class TGeoVGAdapter<vecgeom::UnplacedSphere>+;
  #pragma link C++ class TGeoVGAdapter<vecgeom::UnplacedExtruded>+;
  #pragma link C++ class TGeoVGAdapter<vecgeom::UnplacedBox>+;
  #pragma link C++ class TGeoMultiUnion+;
  #pragma link C++ class TGeoVGAdapter<vecgeom::UnplacedMultiUnion>+;
#endif
